    ...
    return (
        <nav className={`${navbarBackground} z-40 w-full fixed top-0 py-6`}>
            <div className="flex items-center justify-between mx-auto w-5/6">
                <h4 className="font-playfair text-5xl font-bold">AX</h4>
                ...
                {isAboveSmallScreens ? (
                    ...
                    >
                        <img src={require('../assets/menu-icon.svg').default} alt="menu-icon" />
                    </button>
                )}

                {/* MOBILE MENU POPUP */}
                {!isAboveSmallScreens && isMenuToggled && (
                    <div className="fixed right-0 bottom-0 h-full bg-stone w-[300px]">
                        {/* CLOSE ICON */}
