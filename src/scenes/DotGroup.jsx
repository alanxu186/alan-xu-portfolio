...
const DotGroup = ({ selectedPage, setSelectedPage }) => {
    ...
    const selectedStyles = `relative bg-sleepy-blue before:absolute before:w-6 before:h-6 before:rounded-full before:border-2 before:border-sleepy-blue before:left-[-50%] before:top-[-50%]`;
